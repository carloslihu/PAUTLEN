...
/*
	REGLA 1
*/
programa: TOK_MAIN TOK_LLAVEIZQUIERDA escritura0 declaraciones escritura1 funciones escritura2 sentencias TOK_LLAVEDERECHA {
		escribir_fin(output);
...
/*
	REGLAS 18 19
*/
identificadores: asignacion_declarativa {
			fprintf(output, ";R18:\t<identificadores> ::= <identificador>\n");
		}
	| asignacion_declarativa TOK_COMA identificadores {fprintf(output, ";R19:\t<identificadores> ::= <identificador> , <identificadores>\n");}
	;

asignacion_declarativa: identificador TOK_ASIGNACION constante {
		...
		info->n_param = 1;
		fprintf(output, "\t_%s dd %d\n", $1.lexema, $3.valor_entero);
	}
	| identificador
